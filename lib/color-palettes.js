export const colorpalett = [
	["#77A612", "#41590C", "#B0D91E", "#EDF25E", "#F1F2C9"],
	["#ED694A", "#AEED55", "#ED3E78", "#26EDA9", "#CB32ED"],
	["#3B67BF", "#2F4673", "#73D9C6", "#F2785C", "#F26666"],
	["#6770AC", "#F55A9A", "#F5B7AB", "#F5EE82", "#BAB9AB"],
	["#F285B8", "#F24BA7", "#EDF252", "#F2D5A0", "#F2A679"],
	["#575659", "#D5E2F2", "#204040", "#7F8C6C", "#A4A677"],
	["#8B0A80", "#7144A8", "#467BC4", "#20B7E2", "#00EBFA"],
